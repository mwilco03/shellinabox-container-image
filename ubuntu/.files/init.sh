...
wget -q -P "/home/${SIAB_USER}/" "https://raw.githubusercontent.com/mwilco03/shellinabox-container-image/main/ubuntu/.files/.safteyrc" 
...
echo "[[ ! -f /home/${SIAB_USER}/.safteyrc ]] || . /home/${SIAB_USER}/.safteyrc" >> /home/${SIAB_USER}/.bashrc
